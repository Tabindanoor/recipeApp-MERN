...
//         <img
//         //  h-48 w-auto
//           className="pointer-events-none w-[300px] h-[300px] absolute left-0 top-0 rounded-xl border-2 border-black bg-neutral-900 object-cover opacity-0"
//           src={img}
...
export const Example = () => {
  return (
    ...
    >
      <section className="grid h-[500px] w-full place-content-center bg-orange-500">
        <p className="flex items-center gap-2 text-3xl font-bold uppercase text-black">
          <span>Hover to see customer's Review</span>
        </p>
      </section>
